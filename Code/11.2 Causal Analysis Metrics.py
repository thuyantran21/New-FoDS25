...
output_path = "../Outputs/11.3 Causal_Impact_Analysis_Lagged_Correlation_Per_Metric.xlsx"
...
#plt.tight_layout()
plt.savefig("../Outputs/11.3 Causal_Impact_Lagged_Correlation_Per_Metric.png")
plt.show()
