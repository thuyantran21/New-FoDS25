...
logistic_df.to_excel("../Output/ML_Model_Results.xlsx", index=False)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../Output/Learning_Curve_Logistic_Regression.png")
plt.show()
...
knn_df.to_excel("../Output/KNN_Results.xlsx", index=False)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../Output/Learning_Curve_KNN.png")
plt.show()
...
# Save results to Excel
results_df.to_excel("../Output/ML_Model_Results.xlsx", index=False)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../Output/Learning_Curve_RF.png")
plt.show()
...
# Save results to Excel
xgb_manual_df.to_excel("../Output/ML_Model_Results.xlsx", index=False)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../Output/Learning_Curve_XGBoost.png")
plt.show()
