...
relevant_metrics = ['Diabetes Deaths', 'Life Expectancy', 'All Cancer Deaths', 'Breast Cancer Deaths', 
                    'Lung Cancer Deaths', 'Cardiovascular Disease Deaths', 'Heart Disease Deaths', 
                     'Pneumonia or Influenza Deaths', 'Maternal Deaths', 
                    'Infant Deaths']
...
plt.savefig("../Output/5.3 Heatmap Correlation of Relevant Health Metrics.jpg")
plt.show()
...
for name, (model, X_used) in models.items():
    ...
    try:
        ...
        if hasattr(model, 'feature_importances_'):
            ...
            plt.tight_layout()
            plt.savefig(f"../Output/5.3 Relevant Health Metrics Analysis - {name}.jpg")
            plt.show()
            ...
            plt.tight_layout()
            plt.savefig("../Output/5.3 Relevant Health Metric Analysis - KNN.jpg")
            plt.show()
...
plt.tight_layout()
plt.savefig("../Output/5.3 Combined Feature Importance.jpg")
plt.show()
