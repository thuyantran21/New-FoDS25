...
with pd.ExcelWriter("../Outputs/11.1 Causal_Impact_Analysis_Comparison.xlsx") as writer:
...
plt.tight_layout()
plt.savefig("../Outputs/11.1 Causal_Impact_all.png")
plt.show()

print("Causal Impact Analysis using Cross-Correlation completed. Results saved to 11.1 Causal_Impact_Analysis_Comparison.xlsx.")
...
with pd.ExcelWriter("../Outputs/11.2 Causal_Impact_Analysis_Comparison_Deaths.xlsx") as writer:
    results_significant.to_excel(writer, sheet_name="Significant_Features", index=False)
    results_all.to_excel(writer, sheet_name="All_Features", index=False)
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("../Outputs/11.2 Causal_Impact_Deaths.png")
plt.show()

print("Causal Impact Analysis using Cross-Correlation completed. Results saved to 11.2 Causal_Impact_Analysis_Comparison_Deaths.xlsx.")
