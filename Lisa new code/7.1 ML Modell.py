...
# Define target metrics (outcome variables) - Results of Metric Evaluation
...
# Top 4 metrics
#metrics = ['Adult Mental Distress', 'Infant Deaths', 'Life Expectancy', 'High Blood Pressure']


#  ['Diabetes Deaths', 'Cardiovascular Disease Deaths', 'Heart Disease Deaths', 'High Blood Pressure', 'Adult Obesity', 'Teen Obesity', 'All Cancer Deaths', 'Breast Cancer Deaths', 'Lung Cancer Deaths', 'Life Expectancy', 'Deaths from All Causes', 'Adult Mental Distress', 'Pneumonia or Influenza Deaths', 'Low Birthweight']
# Store results
