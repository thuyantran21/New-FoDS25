...
# Laden der Daten
data = pd.read_csv('BigCitiesHealth_Cleaned.csv')
...
for hue in features:
    ...
    #plt.savefig(f"../Outputs/9. Subgroups Distribution - {hue}.jpg")
    #plt.show()
...
plt.ylabel('Features')
plt.savefig('../Outputs/9. Feature Value Distribution - Check.jpg')
plt.show()
